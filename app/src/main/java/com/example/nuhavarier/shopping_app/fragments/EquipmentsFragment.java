...
import com.example.nuhavarier.shopping_app.adapters.EquipmentsAdapter;
...
public class EquipmentsFragment extends Fragment {
     ...
     * @return A new instance of fragment EquipmentsFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Equipments");
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_equipments, container, false);
        final TabLayout tabLayout=view.findViewById(R.id.tab_layout);
        final ViewPager viewPager=view.findViewById(R.id.eq_container);
        ...
        EquipmentsAdapter equipmentsAdapter=new EquipmentsAdapter(mContext,getChildFragmentManager(),5);
        viewPager.setAdapter(equipmentsAdapter);
