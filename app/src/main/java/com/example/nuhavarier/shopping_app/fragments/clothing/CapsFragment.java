...
import com.example.nuhavarier.shopping_app.adapters.Clothing1Adapter.CapsAdapter;
...
public class CapsFragment extends Fragment {
     ...
     * @return A new instance of fragment CapsFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_caps, container, false);

        RecyclerView recyclerView=view.findViewById(R.id.recycler_view);
        CapsAdapter capsAdapter=new CapsAdapter();
